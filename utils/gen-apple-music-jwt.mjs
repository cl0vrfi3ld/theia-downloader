// stolen from https://github.com/pelauimagineering/apple-music-token-generator

// apple fucken sucks, this process is needlessly complicated
        ...
        await fetch(url, {
          ...
          .then((response) => {
            ...
            if (response.status == 401) {
              ...
              if (process.argv.indexOf("--test") > -1) {
                ...
                console.log(
                  "The generated token was rejected by the Apple Music API."
                );
                console.log(
          ...
          .then((json) => {
            if (json) {
              ...
              console.log(
                "The JWT was generated but there was an error when it was presented "
              );
            }
